...
title MiausoftSuite - Compilador central
cd /d "%~dp0"
...
cls
echo ============================================================
echo  MIAUSOFTSUITE - COMPILADOR CENTRAL
echo ============================================================
echo  [1] Tlalpowa
echo  [2] Ilnamiki
echo  [3] Biblioteca
echo  [4] MiausoftTools
echo  [5] Toda la suite
echo  [0] Salir
echo ============================================================
choice /C 123450 /N /M "Pulsa un numero: "
if errorlevel 6 exit /b 0
if errorlevel 5 goto run_todo
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0CORE\Compilar.ps1" -Target "%TARGET%"
set "RC=%ERRORLEVEL%"
echo.
if not "%RC%"=="0" (
  echo [ERROR] La compilacion termino con codigo %RC%.
) else (
  echo [OK] %TARGET% quedo compilado.
)
if not "%~1"=="" exit /b %RC%
